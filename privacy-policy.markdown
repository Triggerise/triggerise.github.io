...
Policies:
- Language: English
  Text: "Protecting your data, privacy and personal data (as defined under Article 4(1)
...
- Language: French
  Text: "**POLITIQUE DE CONFIDENTIALITE DE TRIGGERISE**\n
    ...
    vos données."
- Language: Swahili
  Text: "**SERA YA FARAGHA/USIRI YA TRIGGERISE**\nKuhifadhi
